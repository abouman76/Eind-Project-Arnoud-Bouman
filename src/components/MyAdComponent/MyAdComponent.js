        ...
        >
          <div className={styles["radio-buttons"]}>
            ...
            <label className={styles.title} htmlFor="title-details">
              ...
              <input
                className={styles["ad-comp-title"]}
                type="text"
                name="title"
                id="title-details"
            ...
            {errors.title && (
              <p className={styles["errors-ad-comp"]}>{errors.title.message}</p>
            )}

            <label className={styles.description} htmlFor="description-details">
              Omschrijf uw advertentie
              <textarea
                className={styles["ad-comp-description"]}
                name="description"
            ...
            {errors.description && (
              <p className={styles["errors-ad-comp"]}>
                {errors.description.message}
              </p>
            )}
          </div>
          <button className={styles["ad-comp-btn"]} type="submit">
            plaats
          </button>
        </form>
      </div>
